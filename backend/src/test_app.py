...
class CapstoneTestCase(unittest.TestCase):
    ...
    The first test for the expected behavior when the UserRole is executive_producer
    The second test for handling one kind of error (405: method_not_allowed)
    The third test for the expected behavior when the UserRole is casting_director
    The fourth tests for the expected behavior when the UserRole is casting_assistant
    """
    ...
    def test_get_movies_method_not_allowed(self):
        res = self.client().get('/movies/1', headers=executive_producer_headers)
        data = json.loads(res.data)
    ...
    def test_get_movies_casting_director(self):
        res = self.client().get('/movies',headers=casting_director_headers)
        data = json.loads(res.data)
    ...
    def test_create_movie(self):
        res = self.client().post('/movies' , json=self.new_movie, headers=executive_producer_headers)
    ...
    def test_if_movie_creation_not_allowed(self):
        res = self.client().post('/movies/1' , json=self.new_movie, headers=executive_producer_headers)
        data = json.loads(res.data)
    ...
    def test_create_movie_casting_director(self):
        res = self.client().post('/movies' , json=self.new_movie, headers=casting_director_headers)
        data = json.loads(res.data)
    ...
    def test_create_movie_casting_assistant(self):
        res = self.client().post('/movies' , json=self.new_movie, headers=casting_assistant_headers)
        data = json.loads(res.data)
    ...
    The first test for the expected behavior
    The second test for handling one kind of error (422: request unprocessable - when the movie_id is not exist)
    NOTE: the error code for second TestCase could be 404: Not Found as well
    """     
    def test_update_movie(self):
        mv = Movie.query.first()
        res = self.client().patch('/movies/'+str(mv.id) , json=self.new_movie, headers=executive_producer_headers)
        data = json.loads(res.data)
    ...
    def test_update_movies_if_not_exist(self):
        res = self.client().patch('/movies/20000' , json=self.new_movie, headers=executive_producer_headers)
        data = json.loads(res.data)
    ...
    def test_delete_movies(self):
        mv = Movie.query.first()
        res = self.client().delete('/movies/'+str(mv.id), headers=executive_producer_headers)
        data = json.loads(res.data)
    ...
    def test_delete_movies_if_not_exist(self):
        res = self.client().delete('/movies/2000', headers=executive_producer_headers)
        data = json.loads(res.data)
    ...
    def test_get_actors_method_not_allowed(self):
        res = self.client().get('/actors/1', headers=executive_producer_headers)
        data = json.loads(res.data)
    ...
    def test_create_actor(self):
        res = self.client().post('/actors' , json=self.new_actor, headers=executive_producer_headers)
        data = json.loads(res.data)
    ...
    def test_if_actor_creation_not_allowed(self):
        res = self.client().post('/actors/1' , json=self.new_actor, headers=executive_producer_headers)
        data = json.loads(res.data)
    ...
    def test_create_actor_casting_assistant(self):
        res = self.client().post('/actors' , json=self.new_actor, headers=casting_assistant_headers)
        data = json.loads(res.data)
    ...
    The first test for the expected behavior
    The second test for handling one kind of error (422: request unprocessable - when the actor_id is not exist)
    NOTE: the error code for second TestCase could be 404: Not Found as well
    """     
    def test_update_actor(self):
        ac = Actor.query.first()
        res = self.client().patch('/actors/'+str(ac.id) , json=self.new_actor, headers=executive_producer_headers)
        data = json.loads(res.data)
    ...
    def test_update_actors_if_not_exist(self):
        res = self.client().patch('/actors/20000' , json=self.new_actor, headers=executive_producer_headers)
        data = json.loads(res.data)
    ...
    def test_delete_actors(self):
        ac = Actor.query.first()
        res = self.client().delete('/actors/'+str(ac.id), headers=executive_producer_headers)
        data = json.loads(res.data)
    ...
    def test_delete_actors_if_not_exist(self):
        res = self.client().delete('/actors/2000', headers=executive_producer_headers)
        data = json.loads(res.data)
